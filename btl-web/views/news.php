    ...
    <div class="container about-content">
        <section class="row" id="news-list">
            ...
            <?php else: ?>
                <div class="col-md-12">
                    <br>
                    <button id="back-btn" onclick="setSessionCookie(<?php echo ($curpage - 1); ?>)"
                        class="btn-back-and-forth">Back</button>
                    <button class="page-num" disabled="true">Page <?php echo $curpage ?> / <?php echo $npage ?></button>
                    <button id="forth-btn" onclick="setSessionCookie(<?php echo ($curpage + 1); ?>)"
                        class="btn-back-and-forth">Next</button>
                    <br>
                </div>
                    ...
                    <a href="#" onclick="<?php echo ("showNews($news_id);"); ?>">
                        <div class="col-md-4">
                            <div class="card">
                                ...
                                <img src="public/img/<?php echo $news_image ?>" alt="News Image"
