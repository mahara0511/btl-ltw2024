                    ...
                    <div class="row">
                        <form class="  col-xs-10 col-xs-offset-1 was-validated" novalidate id="register-form" method="post">
                                ...
                                <label class=" control-label text-left" for="email">Email</label>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label" for="firstname">First name</label>
                                            ...
                                            <div class=" has-feedback has-clear mb-3">
                                                <input id="firstname" type="text" class="form-control " name="firstname"  data-length="30" maxlength="30" required placeholder="First Name">
                                                <a class="form-control-clear" ><i class=" material-icons">clear</i></a>
                                                <div class="invalid-feedback hidden">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label text-left" for="lastname">Last name</label>
                                            ...
                                            <div class=" has-feedback has-clear mb-3">
                                                <input id="lastname" type="text" class="form-control " name="lastname"  data-length="30" maxlength="30" required placeholder="First Name">
                                                <a class="form-control-clear" ><i class=" material-icons">clear</i></a>
                                                <div class="invalid-feedback hidden">
                                                    Please provide a valid name.
                                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class=" has-feedback has-clear mb-3">
                                    <input id="mobile" type="text" class="form-control" name="mobile"  data-length="30" maxlength="15" required placeholder="Mobile">
                                    <a class="form-control-clear" ><i class=" material-icons">clear</i></a>
                                    <div class="invalid-feedback hidden">
                            ...
                            <div class="form-group">
                                ...
                                <div class=" has-feedback has-clear mb-3">
                                    <input id="address" type="text" class="form-control" name="address"  data-length="30" maxlength="255" required placeholder="Address">
                                    <a class="form-control-clear" ><i class=" material-icons">clear</i></a>
                                    <div class="invalid-feedback hidden">
                            ...
                            <div class="form-group">
                                ...
                                <div class=" has-feedback has-clear mb-3">
                                    <input id="province" type="text" class="form-control" name="province"  data-length="30" maxlength="255" required placeholder="Province">
                                    <a class="form-control-clear" ><i class=" material-icons">clear</i></a>
                                    <div class="invalid-feedback hidden">
                            ...
                            <div class="form-group">
                                ...
                                <div class=" has-feedback has-clear mb-3">
                                    <input id="district" type="text" class="form-control" name="district"  data-length="30" maxlength="255" required placeholder="District">
                                    <a class="form-control-clear" ><i class=" material-icons">clear</i></a>
                                    <div class="invalid-feedback hidden">
                            ...
                            <div class=" row">
                                ...
                                <div class="col-xs-1 col-xs-offset-5">
                                    <button type="submit" class="btn btn-primary " disabled id="submit-button" name="register" style="margin: 50px auto">Submit</button>
                                </div>
                            </div>
